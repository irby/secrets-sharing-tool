...
- [SHA-256/RSA](https://docs.microsoft.com/en-us/dotnet/api/system.security.cryptography.rsapkcs1signatureformatter?view=net-5.0) is used to hash the encrypted message to ensure it was not modified
